...
module  clkinter_altclkctrl_0_sub
	( 
	ena,
	inclk,
...
`endif
	...
	assign
		...
		inclk_wire = {inclk},
		outclk = wire_clkctrl1_outclk;
endmodule //clkinter_altclkctrl_0_sub
...
module  clkinter_altclkctrl_0  (
    ...
    clkinter_altclkctrl_0_sub  clkinter_altclkctrl_0_sub_component (
                .ena (sub_wire1),
                .inclk (sub_wire3),
                .outclk (sub_wire0));
