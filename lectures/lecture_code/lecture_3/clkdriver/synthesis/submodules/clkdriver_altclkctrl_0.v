//altclkctrl CBX_SINGLE_OUTPUT_FILE="ON" CLOCK_TYPE="External Clock Output" DEVICE_FAMILY="Cyclone IV E" ENA_REGISTER_MODE="double register" USE_GLITCH_FREE_SWITCH_OVER_IMPLEMENTATION="OFF" ena inclk outclk
...
module  clkdriver_altclkctrl_0_sub
	( 
	ena,
	inclk,
...
endmodule //clkdriver_altclkctrl_0_sub
...
module  clkdriver_altclkctrl_0  (
    ...
    clkdriver_altclkctrl_0_sub  clkdriver_altclkctrl_0_sub_component (
                .ena (sub_wire1),
                .inclk (sub_wire3),
                .outclk (sub_wire0));
